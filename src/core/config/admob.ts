// ⚠️ ADMOB DESHABILITADO TEMPORALMENTE
// Se habilitará después de publicar en Play Store

// Configuración de AdMob - DESHABILITADA
// IDs vacíos para evitar crashes

export const ADMOB_REWARDED_ID = '';
export const ADMOB_INTERSTITIAL_ID = '';
export const ADMOB_BANNER_ID = '';
export const ADMOB_NATIVE_ID = '';

/* 
===========================================
CONFIGURACIÓN ORIGINAL (RESTAURAR DESPUÉS)
===========================================
