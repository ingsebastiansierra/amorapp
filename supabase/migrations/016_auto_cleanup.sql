-- Migración: Sistema de limpieza automática de datos sensibles
-- Fecha: 2026-02-17
-- 
-- Esta migración crea funciones para:
-- 1. Limpiar mensajes antiguos (más de 7 días)
-- 2. Limpiar notas de voz antiguas (más de 7 días)
-- 3. Limpiar imágenes antiguas (más de 7 días)
-- 4. Limpiar historial de estados emocionales (mantener solo últimos 30 días)
